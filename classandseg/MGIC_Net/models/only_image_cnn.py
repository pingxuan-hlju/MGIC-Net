...
class OnlyImageCnn(nn.Module):
    ...
    def CMSA_layer(self, in_feats, dim, conv, maxpool, final_conv, relu_cmsa, softmax_cmsa):
        ...
        query = torch.reshape(
            query, [in_feats.shape[0], dim, -1])  # [10, 161, 9]
        # [10, 9, 161] instead of transposing key, i transposed query
        ...
        value = torch.reshape(
            value, [in_feats.shape[0], dim, -1])  # [10, 161, 1]
